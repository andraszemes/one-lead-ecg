...
Keď pokojový membránový potenciál dosiahne určitú prahovú hodnotu (cca. 15 mV), tzv. \emph{akčný potenciál}, tento pokojový stav sa náhle zmení. V membráne bunky sa otvoria prieduchy a kladne nabité ióny prúdia späť do bunky. Táto náhla strata polarizácie sa volá depolarizácia \linebreak a vzniká pri nej elektrický prúd.
...
Najdôležitejšou ochranou je vylúčenie napájania laboratórnym zdrojom. Pri nesprávnom nastavení alebo poruche zdroja by sa nebezpečný prúd mohol dostať do kontaktu s telom vyšetrovaného. Aby sa podobnému scenáru zabránilo, obvod napájajú tri AA články (4,5V). 
...
Jednosmerné prúdy do 3 mA nevyvolávajú obyčajne žiadny pocit. Pri 5-10 mA sú sprievodné znaky svrbenie a pocit tepla. Ak prúd prechádza hrudníkom, pri prúdoch 80-100 mA je dýchanie takmer nemožné, komory srdca sa začnú kŕčovito sťahovať (fibrilácia komôr) a dochádza k zástave krvného obehu.
...
\begin{itemize}
	...
	\item Hrudný zvod č. 2 - okrem vysokoimpedančného vstupu zosilňovača je tiež spojený s výstupom cez \SI{100}{\kilo\ohm} rezistor. Treba si však uvedomiť, že tento prúd ani pri maximálnych hodnotách (4,5V) nepresahuje 0,045mA.
\end{itemize}
